...
router.post('/switch', async (req, res) => {
    const { site } = req.body;
    if (!["https://us4-ubg.github.io", "https://trigonometry.texasmath.net", "https://petezahgames.com", "https://securedweb.xyz", "https://flamepass.com", "https://watch.bludclart.com"].includes(site)) {
