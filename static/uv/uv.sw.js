...
class UVServiceWorker extends EventEmitter {
    constructor(e=__uv$config) {
        ...
        "Firefox" === this.browser && (this.headers.forward.push("user-agent"),
            this.headers.forward.push("content-type"))
    }
    async fetch({request: e}) {
        if ((!e.url.startsWith(location.origin + (this.config.prefix || "/service/"))) || e.url.includes('uv.'))
            return fetch(e);
        try {
            ...
            if ("blob:" === t.meta.url.protocol && (n.blob = !0,
            ...
            e.referrer && e.referrer.startsWith(location.origin)) {
                ...
                (n.headers.origin || t.meta.url.origin !== r.origin && "cors" === e.mode) && (n.headers.origin = r.origin),
                    n.headers.referer = r.href
            }
            const s = await t.cookie.getCookies(r) || []
                , i = t.cookie.serialize(s, t.meta, !1);
            "Firefox" === this.browser && "iframe" !== e.destination && "document" !== e.destination && n.forward.shift(),
            i && (n.headers.cookie = i),
                n.headers.Host = n.url.host;
            const o = new HookEvent(n,null,null);
            if (this.emit("request", o),
                o.intercepted)
            ...
            if (this.emit("beforemod", u),
                u.intercepted)
                return u.returnValue;
            for (const e of this.headers.csp)
                c.headers[e] && delete c.headers[e];
            if (c.headers.location && (c.headers.location = t.rewriteUrl(c.headers.location)),
            c.headers["set-cookie"] && (Promise.resolve(t.cookie.setCookies(c.headers["set-cookie"], r, t.meta)).then(( () => {
            ...
            return "text/event-stream" === n.headers.accept && (c.headers["content-type"] = "text/event-stream"),
                this.emit("response", u),
                u.intercepted ? u.returnValue : new Response(c.body,{
                    headers: c.headers,
                    status: c.status,
...
var ReflectOwnKeys, R = "object" == typeof Reflect ? Reflect : null, ReflectApply = R && "function" == typeof R.apply ? R.apply : function(e, t, r) {
...
Object.defineProperty(EventEmitter, "defaultMaxListeners", {
    ...
    EventEmitter.prototype.emit = function(e) {
        ...
        if ("function" == typeof a)
            ReflectApply(a, this, t);
        else {
            var c = a.length
                , u = arrayClone(a, c);
            for (r = 0; r < c; ++r)
                ReflectApply(u[r], this, t)
        }
        return !0
    }
    ,
